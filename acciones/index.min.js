...
function generarContenido(pdf) {
  ...
  pdf.text('Frescas y Maduradas Colombia S.A.S', 65, 45);
  pdf.text('NIT 900.704.771-7', 85, 53);
  ...
  pdf.text('Analista TH y Administrativo', 20, 220);
  pdf.text('Tel: 3105462538', 20, 238);
  pdf.text('Departamento de Talento Humano', 20, 246);
